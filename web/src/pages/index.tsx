...
import usersAvatarsExampleImage from "../assets/users-avatar-example.png";
...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent){
    ...
    try{
      ...
      setPoolTitle('');
      alert('Bolão criado com sucesso! O código foi copiado par a área de transferência.')
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        <Image src={logoImg} alt="Bolão da Copa" />
